...
/**
* Updates information in Assign to Subprogram Chair, 
* Assign to Reviewer and Accept Decision Panels.
* 
* @author CleanCode
*
*/
public class MyTableModelListener implements 
   ...
   /** Panel that lets Program Chair assign Paper 
    * to Subprogram Chair.
    *  Panel that lets Subprogram Chair assign Paper 
    *  to Reviewers.*/
    ...
    * @param theAssignToPaper panel that lets assign a 
    * user to the paper.
    * @param theAcceptPaper panel that lets Program Chair 
    * accept/deny paper.
   ...
   public MyTableModelListener(final UI_PaperTable theTable, 
		   					   final UI_AssignToPaper 
		   					   theAssignToPaper, 
		   					   final UI_AcceptanceDecision 
		   					   theAcceptPaper,
		   					   final int theRoleId, 
		   					   final int theUserId) {
	   super();
   ...
   /**
    * Changes the paper that will be displayed in the 
    * other panels.
    * 
    * @param theEvent event that specifies if a table 
    * row has been selected.
    */
	@Override
	public void valueChanged(ListSelectionEvent theEvent) {
		final int row = myPaperTable.getTable()
				.getSelectedRow();
		Paper tempPaper = myPaperTable.getSelectedPaper(
				row);
